...
class TemplatesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 100, 'null' => true, 'default' => null, 'comment' => '模板名称', 'precision' => null, 'fixed' => null],
        'type' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '模板分类， 200，300，50户数', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'type' => 1,
            'created' => '2016-06-29 16:37:03',
            'modified' => '2016-06-29 16:37:03'
        ],
    ];
}
