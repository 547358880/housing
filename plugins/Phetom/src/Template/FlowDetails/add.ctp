<div class="bjui-pageContent">
    <form action="<?php echo $this->request->base.'/'.strtolower($this->request->params['plugin']);?>/flowDetails/add/<?php echo $item_id;?>" class="pageForm" data-toggle="validate" data-reloadNavtab="ture" >
        ...
        <table class="table table-condensed table-hover">
            ...
            <tr>
                <td>
                    ...
                    <input type="text" name="parent.name" value="<?php if(isset($data) && !empty($data->name)){echo $data->name;}?>" class="form-control input-nm" data-title="查找上级" size="35" data-toggle="lookup" data-url="<?php echo $this->request->base.'/'.strtolower($this->request->params['plugin']);?>/flowDetails/lookup/<?php echo $item_id;?>" data-group="parent" data-width="800" data-height="600">
            ...
            <tr>
                <td>
                    ...
                    <input type="text" name="endtime" value="" size="35" class="form-control input-nm" data-rule="required;" data-toggle="datepicker" data-pattern="yyyy-MM-dd">
                    <span style="color:#ff0000;">*</span>
                </td>
            </tr>
            </tbody>
