...
<div class="bjui-pageContent">
    <form action="<?php echo $this->request->base.'/'.strtolower($this->request->params['plugin']);?>/articles/add" class="pageForm" data-toggle="validate" data-reloadNavtab="ture" >
        <table class="table table-condensed table-hover">
            <tbody>
            <tr>
                <td>
                    <label class="control-label x85">标&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;题：</label>
                    <input type="text" name="title" size="65" class="form-control input-nm" data-rule="required">
            ...
            <tr>
                <td>
                    ...
                    <input type="text" name="shorttitle" size="25" class="form-control input-nm">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <label class="control-label x85">标题颜色：</label>
                    <input type="text" name="color" id="j_custom_color" class="form-control input-nm" value="" data-toggle="colorpicker" data-bgcolor="true" size="14" >
            ...
            <tr>
                <td style="padding-top: 6px;padding-bottom: 6px;">
                    ...
                    <input type="checkbox" name="iscommend" id="j_custom_iscommend" data-toggle="icheck" value="1" data-label="推荐">&nbsp;&nbsp;
            ...
            <tr>
                <td>
                    ...
                    <input type="text" name="author" size="25" class="form-control input-nm">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <label class="control-label x85">发布时间：</label>
                    <input type="text" name="pubdate" size="22" value="<?php echo date('Y-m-d H:i:s');?>" class="form-control input-nm" data-toggle="datepicker" data-pattern="yyyy-MM-dd HH:mm:ss">
                </td>
            </tr>
            <tr>
                <td>
                    <label class="control-label x85">来&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;源：</label>
                    <input type="text" name="source" size="25" class="form-control input-nm">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <label class="control-label x85">浏览次数：</label>
                    <input type="text" name="click" value="0" size="22" class="form-control input-nm" data-rule="digits">
                </td>
            </tr>
            <tr>
                <td >
